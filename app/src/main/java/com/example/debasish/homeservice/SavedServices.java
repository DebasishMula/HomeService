...
public class SavedServices extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView=findViewById(R.id.listView_of_savedServices);
        ...
        BackgroundTaskInSavedServices backgroundTaskInSavedServices=new BackgroundTaskInSavedServices();
        backgroundTaskInSavedServices.execute(serviceman_id);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent=new Intent(SavedServices.this,ViewSavedServices.class);
    ...
    class BackgroundTaskInSavedServices extends AsyncTask<String,Void,String>
    {
        String PhpUrl;
        String JsonString;
        ProgressDialog progressDialog=new ProgressDialog(SavedServices.this);
        @Override
        protected void onPreExecute() {
            PhpUrl="https://androiddbepizycom.000webhostapp.com/Home%20Service/SavedServices.php";
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                while (count<jsonArray.length())
                {
                    ...
                    HiringServicemanInfo hiringServicemanInfo=new HiringServicemanInfo(services_id,user_id,user_name,user_phone_number,user_home_town,working_date,working_address,working_descrip);

                    list.add(hiringServicemanInfo);
                    count++;

                }
                listView.setAdapter(new ArrayAdapterInSavedServices(SavedServices.this,list));
